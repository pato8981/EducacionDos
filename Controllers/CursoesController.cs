...
namespace EducacionDos.Controllers
{
    public class CursoesController : Controller
    {
        ...
        public CursoesController(EducacionDosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCurso,Descripcion")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCurso,Descripcion")] Curso curso)
        {
            if (id != curso.IdCurso)
            {
                return NotFound();
