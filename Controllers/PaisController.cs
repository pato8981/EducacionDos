...
namespace EducacionDos.Controllers
{
    public class PaisController : Controller
    {
        ...
        public PaisController(EducacionDosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPais,Descripcion")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPais,Descripcion")] Pais pais)
        {
            if (id != pais.IdPais)
            {
                return NotFound();
